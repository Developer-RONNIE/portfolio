export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Ensuring Open, Effective client communication",
      description: "",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
      imgClassName: "w-full h-full",
      titleClassName: "justify-end text-mycolor-200",
      img: "/rbk.svg",
      spareImg: "",
    },
    {
  ...
  export const projects = [
    ...
    {
      id: 3,
      title: "Careplus - App for Booking Doctor Appointments",
      des: "CarePlus simplifies booking doctor appointments, offering an easy-to-use platform for managing your healthcare needs effortlessly",
      img: "/p3.svg",
    ...
    {
      id: 4,
      title: "Easy Scrape - Google Maps Data Scraper Extension",
      des: "Easy Scrape is an extension designed for business owners and analysts to effortlessly extract and analyze data from Google Maps",
      img: "/p4.svg",
