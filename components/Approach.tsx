    ...
    <section className = "w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        ...
        <Card 
            ...
            description = "Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketeches to poslished build, I keep you updated every step of the way. ">
          <CanvasRevealEffect
            animationSpeed={3}
